    ...
    <footer>
      ...
      <div className="bg-footer-light py-14">
        <Container className="grid grid-cols-1 gap-10 md:grid-cols-3">
          {/* About */}
          <div>
            <h3 className="text-lg font-bold text-ink">{footer.about.heading}</h3>
            <p className="mt-4 text-sm leading-relaxed text-ink-soft">
              <strong className="text-ink">InCorp Vietnam</strong>{" "}
              {footer.about.body.replace(/^InCorp Vietnam\s*/, "")}
            </p>
          </div>

          {/* Contact */}
          <div>
            <h3 className="text-lg font-bold text-ink">{footer.contact.heading}</h3>
            <div className="mt-4 space-y-4 text-sm text-ink-soft">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href={footer.contact.phoneHref} className="hover:text-brand-600">
                  {footer.contact.phone}
                </a>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="h-5 w-5 shrink-0 text-brand-600" />
                <a href={footer.contact.emailHref} className="hover:text-brand-600">
